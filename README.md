...
└── css/
    ...
    ├── common.css      (아르샤 공통 컬러 변수 및 공통 레이아웃 스타일)
    ├── part1.css       (유채영 담당 섹션 스타일)
    ├── part2.css       (홍연우 담당 섹션 스타일)
    ├── part3.css       (정다희 담당 섹션 스타일)
    └── part4.css       (이주헌 담당 섹션 스타일)
```
* `common.css`에 명시되어 있는 색상을 홈페이지 기본 색상으로 사용합니다. 
